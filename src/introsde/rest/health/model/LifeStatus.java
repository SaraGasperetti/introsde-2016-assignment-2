...
//    }
    /**
     * Get the lifestatus of one person of a specified type (if the db is
     * consistent, it should be just one, otherwies the first one is returned)
     *
    ...
    /**
     * Create a new lifestatus for a specified type and store the old one in the
     * person history
     *
