...
import introsde.rest.health.resources.PersonHistoryResource;
...
public class PersonCollectionResource {
    ...
    public PersonHistoryResource getPersonHistory(@PathParam("personId") int id, @PathParam("measureType") String measureType) {
